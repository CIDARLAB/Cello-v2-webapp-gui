    ...
    var r = e('../config').$modes,
      ...
      o = function () {
        (this.$rules = {
          start: [
            {
              ...
              onMatch: function (e, t, n, r) {
                var i = /^\s*/.exec(r)[0],
                  ...
                  o = s[2];
                return (
                  /^(javascript|ruby|coffee|markdown|css|scss|sass|less)$/.test(o) || (o = ''),
            ...
            { token: 'constant.begin.coffeescript.filter.slim', regex: '^(\\s*)():$' },
          ...
          rubyline: [
            { token: 'keyword.operator.ruby.embedded.slim', regex: "(==|=)(<>|><|<'|'<|<|>)?|-" },
            {
          ...
          misc: [
            { token: 'class.variable.slim', regex: '\\@([a-zA-Z_][a-zA-Z0-9_]*)\\b' },
          ...
          this.$rules = {
            start: [
              ...
              { token: 'string', regex: "['].*\\\\$", next: 'qstring' },
              {
                ...
                regex:
                  a + '(?:ch|cm|deg|em|ex|fr|gd|grad|Hz|in|kHz|mm|ms|pc|pt|px|rad|rem|s|turn|vh|vmax|vmin|vm|vw|%)',
              },
              { token: 'constant.numeric', regex: '#[a-f0-9]{6}' },
              { token: 'constant.numeric', regex: '#[a-f0-9]{3}' },
              { token: 'constant.numeric', regex: a },
