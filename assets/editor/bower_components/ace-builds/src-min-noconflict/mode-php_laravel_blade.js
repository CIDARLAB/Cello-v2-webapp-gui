      ...
      var r = e('../lib/oop'),
        ...
        s = function () {
          ...
          var e = {
              ...
              comments: [
                { token: 'punctuation.definition.comment.blade', regex: '(\\/\\/(.)*)|(\\#(.)*)', next: 'pop' },
                {
                  token: 'punctuation.definition.comment.begin.php',
                  regex: '(?:\\/\\*)',
                  push: [
                    { token: 'punctuation.definition.comment.end.php', regex: '(?:\\*\\/)', next: 'pop' },
                ...
                },
                {
                  ...
                  regex: '(?:\\{\\{\\-\\-)',
                  push: [
                    { token: 'punctuation.definition.comment.end.blade', regex: '(?:\\-\\-\\}\\})', next: 'pop' },
                    { defaultToken: 'comment.block.blade' },
                  ],
                },
              ],
