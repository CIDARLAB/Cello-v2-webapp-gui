        ...
        o = function () {
          var e = [
            ...
            o = (this.$keywords = this.createKeywordMapper(
              { 'keyword.control': e, 'storage.type': n, 'keyword.operator': s, 'variable.language': 'sorry' },
              'identifier'
            )),
            u =
          ...
          (this.$rules = {
            start: [
              ...
              { token: 'keyword.control', regex: t, next: [{ token: 'variable.language', regex: u, next: 'start' }] },
