define('ace/mode/perl6_highlight_rules', [
  'require',
  'exports',
  'module',
  'ace/lib/oop',
    ...
    s = function () {
      var e =
        ...
        s = this.createKeywordMapper(
          { keyword: e, 'storage.type': t, 'constant.language': r, 'support.function': n, 'keyword.operator': i },
          'identifier'
        ),
      ...
      this.$rules = {
        start: [
          ...
          b,
          { token: ['keyword', 'text', 'variable.module'], regex: '(use)(\\s+)((?:' + o + '\\.?)*)' },
          u,
          a,
          f,
          l,
        ...
        qqstring: [
          { token: 'constant.language.escape', regex: '\\\\(?:[nrtef\\\\"$]|[0-7]{1,3}|x[0-9A-Fa-f]{1,2})' },
          d,
          v,
