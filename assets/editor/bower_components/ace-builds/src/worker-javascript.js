          ...
          (function (global) {
            (function () {
              ...
              typedArrayTags[argsTag] = typedArrayTags[arrayTag] = typedArrayTags[arrayBufferTag] = typedArrayTags[
                boolTag
              ] = typedArrayTags[dateTag] = typedArrayTags[errorTag] = typedArrayTags[funcTag] = typedArrayTags[
                mapTag
              ...
              cloneableTags[argsTag] = cloneableTags[arrayTag] = cloneableTags[arrayBufferTag] = cloneableTags[
                boolTag
              ] = cloneableTags[dateTag] = cloneableTags[float32Tag] = cloneableTags[float64Tag] = cloneableTags[
                int8Tag
              ] = cloneableTags[int16Tag] = cloneableTags[int32Tag] = cloneableTags[numberTag] = cloneableTags[
                objectTag
              ] = cloneableTags[regexpTag] = cloneableTags[stringTag] = cloneableTags[uint8Tag] = cloneableTags[
                uint8ClampedTag
              ...
              var reIsNative = RegExp(
                '^' +
                  escapeRegExp(objToString).replace(/toString|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') +
                  '$'
              );
              ...
              var ArrayBuffer = isNative((ArrayBuffer = root.ArrayBuffer)) && ArrayBuffer,
                ...
                getOwnPropertySymbols =
                  isNative((getOwnPropertySymbols = Object.getOwnPropertySymbols)) && getOwnPropertySymbols,
                getPrototypeOf = isNative((getPrototypeOf = Object.getPrototypeOf)) && getPrototypeOf,
                push = arrayProto.push,
                preventExtensions =
                  isNative((Object.preventExtensions = Object.preventExtensions)) && preventExtensions,
              ...
              function shimKeys(object) {
                ...
                var allowIndexes =
                  length && isLength(length) && (isArray(object) || (support.nonEnumArgs && isArguments(object)));
          ...
          var JSHINT = (function () {
            ...
            function parseFinalSemicolon() {
              if (state.tokens.next.id !== ';') {
                ...
                var sameLine =
                  startLine(state.tokens.next) === state.tokens.curr.line && state.tokens.next.id !== '(end)';
          ...
          var scopeManager = function (state, predefined, exported, declared) {
            ...
            var scopeManagerInst = {
              ...
              addlabel: function (labelName, opts) {
                ...
                var isexported =
                  (isblockscoped ? _current : _currentFunctBody)['(type)'] === 'global' && _.has(exported, labelName);
                _checkOuterShadow(labelName, token, type);
                if (isblockscoped) {
